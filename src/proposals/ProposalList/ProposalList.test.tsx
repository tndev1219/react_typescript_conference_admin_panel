...
import ProposalList, { Props as ProposalListProps } from "./ProposalList";

const proposalFixture = (overrides: Partial<Proposal>): Proposal => ({
    id: "any-id",
    title: "Any Title",
    speaker: "Any Speaker",
...
const renderProposalList = (props: Partial<ProposalListProps>): ReactWrapper =>
    mount(
...
const listItemsIn = (tree: ReactWrapper) => tree.find(".ProposalList__item");
